...
namespace RaceSpotLiveryAPI.Migrations
{
    ...
    [Migration("20210328053714_AddEmailFlagToUserAndTimestampToLivery")]
    partial class AddEmailFlagToUserAndTimestampToLivery
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaceSpotLiveryAPI.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsAgreedToEmails")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("RaceSpotLiveryAPI.Entities.RejectionNotice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("LiveryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RaceSpotLiveryAPI.Entities.RejectionNotice", b =>
                {
                    b.HasOne("RaceSpotLiveryAPI.Entities.Livery", "Livery")
                        .WithMany("Rejections")
                        .HasForeignKey("LiveryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
